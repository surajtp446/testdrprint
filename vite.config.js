...
function ProductCard({ product, index, onOpen, onAddToCart, addedId }) {
  return (
    <motion.div custom={index} initial="hidden" whileInView="visible"
      ...
      className="group relative bg-[#0c0c0e] border border-white/8 hover:border-white/22 flex flex-col cursor-pointer transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_8px_32px_rgba(0,0,0,0.6)]"
