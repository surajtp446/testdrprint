...
import StudioFlow from '@/components/StudioFlow.jsx';
...
const AboutPage = () => {
  ...
  return (
    <motion.div className="min-h-screen bg-black font-poppins"
      ...
      {/* The Pipeline — how a part moves through the studio */}
      <StudioFlow />
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          >
            ...
            <div className="order-1 md:order-2">
              <p className="text-white/65 text-sm uppercase tracking-[0.4em] mb-5">03 — Equipment</p>
      ...
      <section className="py-20 px-8 bg-[#0d0d0d] border-y border-white/5">
        <div className="container mx-auto max-w-5xl">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <p className="text-white/65 text-sm uppercase tracking-[0.4em] mb-5">04 — Approach</p>
